          ...
          <div className="px-6 pt-3 pb-5 overflow-y-auto flex-1">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <WritingAssistButton
                  contextType="column_extraction"
                  getCurrentText={() => draft.prompt}
                  onResult={(text) => update({ prompt: text })}
                  metadata={{
                    column_name: draft.name,
                    column_format: draft.format,
                    column_tags: draft.format === "tag" ? draft.tags : undefined,
                  }}
                />
                <button
                  type="button"
